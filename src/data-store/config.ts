export default () => ({
  SCRAPER_SERVICE_URL:
    process.env.SCRAPER_SERVICE_URL || 'https://app.elasticdata.io',
  APP_MINIO_END_POINT:
    process.env.APP_MINIO_END_POINT || 'storage.elasticdata.io',
  ...
  APP_MINIO_SECRET_KEY:
    ...
    'wJalrXUtnFEMI/9874c97c907209cpuvpw97bpb/asdasdasdasdasd',
});
