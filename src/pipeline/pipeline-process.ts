...
export class PipelineProcess {
  ...
  public interactionStateChanged$: Subject<UserInteractionState> =
    new Subject();

  constructor(
    private _commandsJson: string,
